...
public class HomeWork extends JFrame implements ListSelectionListener{
	...
	//이벤트	등록
		jlsFont.addListSelectionListener(this);//리스트의 아이템 선택
		jlsFontStyle.addListSelectionListener(this);//리스트의 아이템 선택
		jlsSize.addListSelectionListener(this);//리스트의 아이템 선택
	...
	public void valueChanged(ListSelectionEvent e) {
		if(jlsFont.getValueIsAdjusting()) {
			jtf1.setText(dlmFont.getElementAt(jlsFont.getSelectedIndex()));
			jlSee.setText(dlmFont.getElementAt(jlsFont.getSelectedIndex()));
		}//valueChanged
		
		if(jlsFontStyle.getValueIsAdjusting()) {
			jtf2.setText(dlmFontStyle.getElementAt(jlsFontStyle.getSelectedIndex()));
		}//valueChanged
		
		if(jlsSize.getValueIsAdjusting()) {
			jtf3.setText(String.valueOf(dlmSize.getElementAt(jlsSize.getSelectedIndex())));
			}
		}//valueChanged
